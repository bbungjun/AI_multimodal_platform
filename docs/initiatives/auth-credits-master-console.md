...
| G11 | Integrated E2E, race, migration, security, and portfolio evidence | In Progress — G11A mock only, #153 | Parent #152; branch codex/issue-153-integrated-mock-acceptance | Existing owned runtime/HTTP Interfaces; see g11-integrated-acceptance-spec.md. Actual OAuth/browser/cloud requires separate authorization; first focused test test_verify_integrated_acceptance.py |
