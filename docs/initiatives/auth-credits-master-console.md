...
| G4.3 | Complete ownership access enforcement | Planned | [Accepted G4 spec](g4-ownership-access-control-spec.md); not implemented | Start after B actual merge using B5 Interface handoff; read/mutation/file/ops/cache enforcement, 20-path budget, zero migrations; only then close aggregate G4 |
