...
| G9A | Personal Plan and Usage read model | Goal Prepared | [Issue131](https://github.com/bbungjun/AI_multimodal_platform/issues/131), branch `codex/issue-131-personal-usage-read-model`, [accepted spec](g9a-personal-usage-read-model-spec.md) | Starts at G8 squash `b050320`; exact11/migration0, local mock-only; implementation not started |
