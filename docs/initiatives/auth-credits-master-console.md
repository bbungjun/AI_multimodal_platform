...
| G5C2 | Atomic reserve, settle, release and PostgreSQL proof | Design frozen / Goal prepared | [Issue121](https://github.com/bbungjun/AI_multimodal_platform/issues/121), [aggregate spec](g5-credit-accounting-spec.md), [preparation record](../portfolio/issue-121-credit-accounting-module.md) | Base68e3df6; exact6 paths/migration0; C201–C234, eight groups/races8/checks>=160, accounting2 + inherited regressions. No product caller/provider/frontend |
