...
| G5C1 | Reservation/allocation/Usage persistence and head compatibility | Goal Prepared | [Issue120](https://github.com/bbungjun/AI_multimodal_platform/issues/120), [record](../portfolio/issue-120-credit-accounting-persistence.md) | Branch from merged G5B ffc4b50; exact20 paths, exactly one0006 migration, frozen SHA d55cad9…f8cc; no writer/product wiring |
