...
| G8 | Atomic per-User concurrency enforcement | Goal Prepared | [Issue129](https://github.com/bbungjun/AI_multimodal_platform/issues/129), branch `codex/issue-129-user-concurrency-enforcement`, [accepted spec](g8-user-concurrency-enforcement-spec.md) | Starts from G7 squash `0a88b94`; held Reservation is one atomic top-level slot, exact18/migration0, mock-only; implementation not started |
