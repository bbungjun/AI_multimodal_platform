...
| G7 | Imagen/Veo and pipeline credit integration | In Progress | [Issue127](https://github.com/bbungjun/AI_multimodal_platform/issues/127), branch `codex/issue-127-generation-credit-integration`, [accepted spec](g7-generation-credit-integration-spec.md) | Starts from G6 squash `a6d9656`; one deep generation-credit Module, migration0, mock-only admission/terminal/pipeline proof |
