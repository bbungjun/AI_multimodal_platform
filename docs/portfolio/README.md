...
| G5C credit reservation and settlement | `C1 Mock Verified — Merged / C2 Goal Prepared` | [Issue120 execution](issue-120-credit-accounting-persistence.md), [Issue121 preparation](issue-121-credit-accounting-module.md), [aggregate spec](../initiatives/g5-credit-accounting-spec.md) | C1 PR122 merged68e3df6. C2 exact6/migration0 freezes deep reserve/settle/release Module and eight races; no product charge yet |
