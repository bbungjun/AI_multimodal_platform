...
| Browser login and race-safe Session UX | `Mock Verified` | [Issue #101 record](issue-101-authenticated-workspace-ux.md) | Module/Chromium and isolated generation verified; Draft delivery in progress; no live Google or backend access-control claim |
