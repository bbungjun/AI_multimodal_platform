...
| G5B credit lifecycle | `Planned — Prepared` | [Issue116 design](issue-116-credit-lifecycle.md), [G5B spec](../initiatives/g5-credit-lifecycle-spec.md) | Transaction-composable renewal/Plan/grants + replay receipts; exact20 paths/new migration1; baseline446 PASS only, not implemented |
