...
| G5C credit reservation and settlement | `C1 Mock Verified locally / C2 Planned` | [Issue120 execution](issue-120-credit-accounting-persistence.md), [aggregate spec](../initiatives/g5-credit-accounting-spec.md) | C1 exact20/new0006, schema2/accounting42/downgrade4 and full regressions pass; delivery pending. No accounting writer or product charge yet |
