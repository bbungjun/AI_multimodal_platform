...
| Imagen/Veo and pipeline credit accounting | `Mock Verified locally` | [Issue127 execution](issue-127-generation-credit-integration.md), [G7 spec](../initiatives/g7-generation-credit-integration-spec.md) | Code7e795c2 exact19/migration0; isolated2 each8 groups/races2/checks120, ownership all4 and full regressions passed. Required CI/merge pending; no live provider claim |
...
| [#127](https://github.com/bbungjun/AI_multimodal_platform/issues/127) | [Imagen/Veo and pipeline credit integration](issue-127-generation-credit-integration.md) | Mock Verified locally at `7e795c2`; exact19/migration0, generation-credit2 + ownership4 cycles + Linux/frontend passed; delivery pending |
