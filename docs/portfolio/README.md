...
| G5A credit persistence and rate policy | `Planned` | [Issue115 preparation](issue-115-credit-foundation.md), [G5 split spec](../initiatives/g5-credit-foundation-spec.md) | G5 split A/B/C; A exact17 paths/migration1 Goal prepared; baseline384 PASS, no credit code/runtime yet |
