...
| G5A credit persistence and rate policy | `Mock Verified locally` | [Issue115 execution](issue-115-credit-foundation.md), [G5 split spec](../initiatives/g5-credit-foundation-spec.md) | Four empty tables + immutable integer policy; exact17/migration1. Schema2, auth1, ownership/file4, Linux1229 and frontend48+34 PASS; delivery pending. No lifecycle or billing wiring |
