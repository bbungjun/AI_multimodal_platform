...
| G5C credit reservation and settlement | `Planned / C1 Goal Prepared` | [Issue120 preparation](issue-120-credit-accounting-persistence.md), [aggregate spec](../initiatives/g5-credit-accounting-spec.md) | Single Goal minimum22 path No-Go; C1 exact20/migration1, C2 migration0. No accounting writer or product charge yet |
