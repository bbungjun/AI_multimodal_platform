...
| G5B credit lifecycle | `Locally Mock Verified — delivery pending` | [Issue116 execution](issue-116-credit-lifecycle.md), [PR119](https://github.com/bbungjun/AI_multimodal_platform/pull/119), [G5B spec](../initiatives/g5-credit-lifecycle-spec.md) | exact20/migration1; schema2, lifecycle groups8/races8/checks320 twice, auth1, ownership-file4, Linux1321, frontend48+34; no generation billing wiring |
