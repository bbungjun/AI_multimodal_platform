...
| File ownership, Range and Master-only operations | `Implemented` | [Issue112 execution](issue-112-file-ops-access.md) | B16/migration0, unit proof passed; first runtime hit budget and failed, cleanup0. Not Mock Verified; ownership2 + file-ops2 redesign approved/prepared, not executed; no PR/merge |
