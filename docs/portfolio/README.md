...
| Guarded emergency Session revocation | `Mock Verified` | [Issue99 record](issue-99-emergency-session-revocation.md), [accepted spec](../initiatives/emergency-session-revocation-spec.md) | Admission-disable gate, guarded preview/apply, two isolated PostgreSQL cycles; no live incident drill |
...
| Per-User credits, usage and concurrency | `Mock Verified` | [Integrated acceptance](issue-153-integrated-mock-acceptance.md), [Usage UI](issue-134-personal-usage-ui.md) | 실제 PostgreSQL/Redis와 HTTP 검증 완료; 결제·provider 청구 대사 없음 |
| Audited Master operations and console | `Mock Verified` | [G10 closeout](issue-137-g10-closeout.md), [Master console](issue-148-master-console.md) | 감사 가능한 Plan/bonus/정지·복구와 UI 검증; 실제 Google 계정·live 운영 없음 |
| G5A credit persistence and rate policy | `Mock Verified — Merged` | [Issue115 execution](issue-115-credit-foundation.md), [G5 split spec](../initiatives/g5-credit-foundation-spec.md) | PR118 squash a003257, final3 CI PASS; exact17/migration1, schema2/auth1/ownership-file4/Linux1229/frontend48+34. No lifecycle or billing wiring |
| G5B credit lifecycle | `Mock Verified — Merged` | [Issue116 execution](issue-116-credit-lifecycle.md), [PR119](https://github.com/bbungjun/AI_multimodal_platform/pull/119), [G5B spec](../initiatives/g5-credit-lifecycle-spec.md) | squash ffc4b50; final required3 CI PASS; exact20/migration1, schema2/lifecycle2/auth1/ownership-file4/Linux1321/frontend48+34; no generation billing wiring |
| G5C credit reservation and settlement | `C1 Merged / C2 locally Mock Verified` | [Issue120 execution](issue-120-credit-accounting-persistence.md), [Issue121 execution](issue-121-credit-accounting-module.md), [aggregate spec](../initiatives/g5-credit-accounting-spec.md) | C2 code41b1bf3 exact6/migration0; accounting2 each8 groups/races8/299 checks and inherited regressions pass. PR/CI/merge pending; no product charge yet |
| Personal Plan, Credit, concurrency and Usage read model | `Mock Verified` | [Issue131 execution](issue-131-personal-usage-read-model.md), [G9A spec](../initiatives/g9a-personal-usage-read-model-spec.md) | Code d103a44; one owner-only GET, personal usage2 each8 groups/races3/checks451, inherited ownership4/Linux1558/frontend48+34; G9B/live model attribution excluded |
| Personal Plan and Usage workspace UI | `UI Mock Verified — Merged` | [Issue134 execution](issue-134-personal-usage-ui.md), [PR135](https://github.com/bbungjun/AI_multimodal_platform/pull/135) | Deep runtime parser/view Module, existing-style `/usage`, Session60/Chromium47, four responsive widths and final required3 CI PASS |
| Imagen/Veo and pipeline credit accounting | `Mock Verified — Merged` | [Issue127 execution](issue-127-generation-credit-integration.md), [PR128](https://github.com/bbungjun/AI_multimodal_platform/pull/128), [G7 spec](../initiatives/g7-generation-credit-integration-spec.md) | Code7e795c2 exact19/migration0; isolated2 each8 groups/races2/checks120, ownership all4 and full regressions passed. Required3 CI passed; squash0a88b94; no live provider claim |
| File ownership, Range and Master-only operations | `Implemented` — complete local mock proof | [Issue112 execution/delivery](issue-112-file-ops-access.md) | B16/migration0; ownership2+file-ops2 aggregate998.187s, each metadata348/races2 or FOVE310/A-B10; schema2/auth1/Linux1128/frontend48+34 PASS. Original No-Go retained; final CI/merge status linked in record |
...
| [#99](https://github.com/bbungjun/AI_multimodal_platform/issues/99) | [Emergency Session revocation](issue-99-emergency-session-revocation.md) | [PR133](https://github.com/bbungjun/AI_multimodal_platform/pull/133) squash `d249e97`; final required3 CI PASS |
| [#134](https://github.com/bbungjun/AI_multimodal_platform/issues/134) | [Personal Usage workspace UI](issue-134-personal-usage-ui.md) | [PR135](https://github.com/bbungjun/AI_multimodal_platform/pull/135) squash `1e6e523`; final required3 CI PASS |
